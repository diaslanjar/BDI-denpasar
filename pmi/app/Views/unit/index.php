...
<body id="page-top">
    ...
    <header class="masthead">
        <div class="container px-4 px-lg-5 h-100">
            ...
            <h2 class="text-white font-weight-bold">Daftar Unit</h2>
                <table class="table table-bordered table-secondary" id="table" style="text-align:center">
                    <tr>
                        <th>No.</th>
                        <th>IDUnit</th>
                        <th>Nama Unit</th>
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?php echo $d['provinsi_unit'] ?></td>
                            <td><?php echo $d['kota_unit'] ?></td>
                            <td><?php echo $d['alamat_unit'] ?></td>
                            <td>
                                <a href="<?php echo base_url('unit/edit/' . $d['id']) ?>" class="btn btn-primary">Ubah</a>
                                <a href="<?php echo base_url('unit/delete/' . $d['id']) ?>" class="btn btn-danger">Hapus</a>
                            </td>
                        </tr>
                    <?php
                    }
                ...
                <div class="text-center">
                    <a href="<?php echo base_url('/unit/create') ?>">
                        <button type="button" class="btn btn-success">Tambah Unit</button>
                    </a>
                </div>
                <!-- Footer-->
                <footer>
