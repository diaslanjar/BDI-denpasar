    ...
    <header class="masthead">
        <div class="container px-4 px-lg-5 h-100">
            <div class="row gx-4 gx-lg-5 h-100 align-items-center justify-content-center">
                ...
                <form action="<?php echo base_url('unit/store') ?>" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="provinsi_unit" id="provinsi_unit" class="form-control">
                    </div><br>
                    <div class="form-group">
                        <label class="text-white">Kota Unit</label>
                        <input type="text" name="kota_unit" id="kota_unit" class="form-control">
                    </div><br>
                    <div class="form-group">
                        <label class="text-white">Alamat Unit</label>
                        <input type="text" name="alamat_unit" id="alamat_unit" class="form-control">
                    </div>
                    <br>
                    <div class="form-group text-center">
                        <a href="/unit" class="btn btn-md float-left btn-danger">Kembali</a>
                        <button type="submit" class="btn btn-md float-right btn-success">Tambah</button>
                    </div>
                </form>
                <!-- Footer-->
                <footer>
