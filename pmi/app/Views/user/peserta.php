    ...
    <header class="masthead">
        <div class="container px-4 px-lg-5 h-100">
            <div class="row gx-4 gx-lg-5 h-100 align-items-center justify-content-center text-center">
                <h2 class="text-white font-weight-bold">Biodata Peserta</h2>
                <table class="table table-bordered table-secondary" id="table" style="text-align:center">
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo base_url('user/edit/' . $d['id']) ?>" class="btn btn-primary">Ubah</a>
                                <a href="<?php echo base_url('user/delete/' . $d['id']) ?>" class="btn btn-danger">Hapus</a>
                            </td>
                        </tr>
                    <?php
                    }
