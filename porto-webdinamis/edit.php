...
<body>
    ...
    <header id="header" class="fixed-top d-flex align-items-center">
        <div class="container">
            <div class="header-container d-flex align-items-center justify-content-between">
                <div class="logo">
                    <h1 class="text-light"><a href="index.html"><span>MakanYuk!</span></a></h1>
                ...
                <nav id="navbar" class="navbar">
                    <ul>
                        ...
                        <li><a class="getstarted scrollto" href="#about">Pesan Sekarang</a></li>
                    </ul>
    ...
    <div class="container mt-5">
        ...
        <div class="card">
            <div class="card-body">
            <h2 style="text-align: center;">Ubah Pesanan</h2>
                <?php
                $parameter = $_GET['id_resto'];
                $query = "SELECT * FROM resto WHERE id_resto =" . $parameter;
                ...
                ?>
                <br>
                <form action="update.php?id_resto=<?php echo $parameter; ?>" method="POST">
                    ...
                    <div class="form-group text-center">
                        <a href="resto.php" class="btn btn-md float-left btn-danger">Kembali</a>
